...
//    )
//
//    val currentLanguage = if (isSource) viewModel.sourceLanguage.value else viewModel.targetLanguage.value
//
//    Scaffold(
//        topBar = {
//            TopAppBar(
...
//                        .clickable {
//                            if (isSource) {
//                                viewModel.sourceLanguage.value = language
//                            } else {
//                                viewModel.targetLanguage.value = language
//                            }
//                            onBack()
//                        }
//                ) {
